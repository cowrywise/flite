...
TRANSFER_TYPE = (('Card', 'Card'), ('P2P', 'P2P'),)
STATUS_TYPE = (('SUCCESS', 'SUCCESS'), ('FAILED', 'FAILED'),)


class Transfer(BaseModel):
    sender = models.ForeignKey(User, on_delete=models.CASCADE, related_name='transfer_sender')
    receiver = models.ForeignKey(User, on_delete=models.CASCADE, related_name='transfer_receiver')
    amount = models.FloatField(default=0.0)
    transfer_type = models.CharField(max_length=15, choices=TRANSFER_TYPE)
...
TRANSACTION_TYPE = (('Transfer(P2P)', 'Transfer(P2P)'), ('Withdraw', 'Withdraw'), ('Fund Account', 'Fund Account'))
